        ...
        <ul class="info">
            ...
            <li class="info__list">
                ...
                <p class="info__content">
                    <a href="" class="info__content-link"></a>
                    <img src="" class="info__content-image" alt="">
                </p>
            </li>
            -->
            <li class="info__list">
                ...
                <p class="info__content">
                    ...
                    Try the webpage now at <a href="https://trace.moe" class="info__content-link">https://trace.moe</a>
                </p>
                ...
                <p class="info__content">
                    ...
                    I'm still writing description of this project, which you can find it on Github <a href="https://github.com/soruly/trace.moe-media" class="info__content-link">https://github.com/soruly/trace.moe-media</a>
                </p>
                <h4 class="info__subheading">GIF Preview for Telegram bot</h4>
                <p class="info__content">
                    To try the natural scene cutter, you can use the Telegram bot. <a href="https://telegram.me/WhatAnimeBot" class="info__content-link">https://telegram.me/WhatAnimeBot</a>
                ...
                <p class="info__content">
                    ...
                    Details are written in <a href="https://soruly.github.io/trace.moe/" class="info__content-link">https://soruly.github.io/trace.moe/</a>
                </p>
                ...
                <p class="info__content">
                    ...
                    Instructions are written in details in the project: <a href="https://github.com/soruly/sola" class="info__content-link">https://github.com/soruly/sola</a>
                </p>
            </li>
            <li class="info__list">
                ...
                <p class="info__content">
                    ...
                    I had no choice but immediately moved to <a href="https://trace.moe" class="info__content-link">trace.moe</a> which I've been planning to move to.
                </p>
                <p class="info__content">
                ...
                <p class="info__content">
                    <strong>Why the name <a href="https://trace.moe" class="info__content-link">trace.moe</a>?</strong> This search engine tells you more than the anime name, but actually trace back the moment of the scene.
            ...
            <li class="info__list">
                ...
                <p class="info__content">New testing site on <a href="https://beta.whatanime.ga" class="info__content-link">https://beta.whatanime.ga</a></p>
                <p class="info__content">
                    I've been testing a new beta site with improved performance on search speed.
                    A copy of the 130GB solr core from <a href="http://whatanime.ga" class="info__content-link">http://whatanime.ga</a> is split into 10 smaller cores (10-16GB each, with 59-89 million hashes).
            ...
            <li class="info__list">
                ...
                <p class="info__content">You can subscribe the <a href="https://telegram.me/whatanimeupdates" class="info__content-link">Telegram Channel</a> for database and news updates.</p>
            </li>
            <li class="info__list">
                <span class="info__date">24 Aug 2017</span>
                <h3 class="info__heading">GIF and video support for Telegram Bot</h3>
                <p class="info__content">You can now send GIF or video to the <a href="https://telegram.me/WhatAnimeBot" class="info__content-link">Telegram Bot</a>.</p>
            </li>
            <li class="info__list">
                <span class="info__date">23 Aug 2017</span>
                <h3 class="info__heading">Group chat support for Telegram Bot</h3>
                <p class="info__content">You can now add the <a href="https://telegram.me/WhatAnimeBot" class="info__content-link">Telegram Bot</a> to Telegram group. Use @ to mention the bot on any photo to search.</p>
            </li>
            <li class="info__list">
            ...
            <li class="info__list">
                ...
                <p class="info__content">
                    ...
                    <a href="https://go-talks.appspot.com/github.com/soruly/slides/whatanime.ga-2017.slide" class="info__content-link">Presentation slides on June 2017</a>.
                </p>
            </li>
            <li class="info__list">
            ...
            <li class="info__list">
                ...
                <p class="info__content">
                    ...
                    If you like this project, feel free to <a href="https://www.patreon.com/soruly" class="info__content-link">Support whatanime.ga on Patreon</a>.
                </p>
            </li>
            <li class="info__list">
            ...
            <li class="info__list">
                ...
                <p class="info__content">You can now see the system status in <a href="https://status.whatanime.ga" class="info__content-link">https://status.whatanime.ga</a> (Powered by UptimeRobot).</p>
            </li>
            <li class="info__list">
            ...
            <li class="info__list">
                ...
                <p class="info__content">The <a href="https://telegram.me/WhatAnimeBot" class="info__content-link">Telegram Bot</a> will now sends you a video preview.</p>
            </li>
            <li class="info__list">
                <span class="info__date">17 Jan 2017</span>
                <h3 class="info__heading">Official API released</h3>
                <p class="info__content">The official API is now open for testing. Interested developers may read the page on <a href="https://soruly.github.io/whatanime.ga/" class="info__content-link">GitHub Pages</a>.</p>
            </li>
            <li class="info__list">
                ...
                <p class="info__content">
                    ...
                    You may try loading the zip from <a href="https://github.com/soruly/whatanime.ga-WebExtension/releases" class="info__content-link">GitHub</a> by enabling extension developer features in about:flags.
                </p>
            </li>
            <li class="info__list">
            ...
            <li class="info__list">
                ...
                <p class="info__content">This telegram bot can tell you where an anime screenshot is taken from. Just send / forward an image to <a href="https://telegram.me/WhatAnimeBot" class="info__content-link"">https://telegram.me/WhatAnimeBot</a>.</p>
            </li>
            <li class="info__list">
            ...
            <li class="info__list">
                ...
                <p class="info__content">
                    <a href="https://chrome.google.com/webstore/detail/search-anime-by-screensho/gkamnldpllcbiidlfacaccdoadedncfp" class="info__content-link">Chrome Extension</a>,
                    <a href="https://addons.mozilla.org/en-US/firefox/addon/search-anime-by-screenshot/" class="info__content-link">Firefox Add-on</a>,
                    <a href="https://addons.opera.com/en/extensions/details/search-anime-by-screenshot/" class="info__content-link">Opera Add-on</a> has been relased.
                </p>
                <p class="info__content">Source code available on <a href="https://github.com/soruly/whatanime.ga-WebExtension" class="info__content-link">GitHub</a></p>
            </li>
            <li class="info__list">
            ...
            <li class="info__list">
                ...
                <p class="info__content">Now you can use the <a href="https://chrome.google.com/webstore/detail/search-anime-by-screensho/gkamnldpllcbiidlfacaccdoadedncfp" class="info__content-link">Chrome Extension</a> to search.</p>
            </li>
            <li class="info__list">
                <span class="info__date">28 Feb 2016</span>
            ...
            <li class="info__list">
                ...
                <p class="info__content">To help users to understand how the search engine works, we have added some good and bad screenshots in <a href="/faq" class="info__content-link">FAQ</a>.</p>
            </li>
            <li class="info__list">
