...
<body>
    ...
    <div class="container">
        <ul class="wait-info__group">
            ...
            */ ?>
            <li>
                <h3>Copyright &amp; Intellectual Property Policy</h3>
                <div>
                    <p>trace.moe respects the intellectual property rights of others and expects its users to do the same.</p>
                    <p>It is our policy, in appropriate circumstances and at its discretion, to disable and/or terminate the accounts of users who repeatedly infringe the copyrights or other intellectual property rights of others.</p>
            ...
            <li>
                ...
                <div>
                    <ol>
                        ...
                        <li>
                            <p>Identify the material that you claim is infringing (or to be the subject of infringing activity) and that is to be removed or access to which is to be disabled, and information reasonably sufficient to permit us to locate the material on the Services.</p>
                        </li>
                        <li>
                    ...
                    <p>Deliver this Notice, with all items completed, to our contact at <a href="mailto:help@trace.moe">help@trace.moe</a></p>
                </div>
            </li>
            <li>
                <h3>Notification of Trademark Infringement:</h3>
                <div>
                    <p>If you believe that your trademark (the “Mark”) is being used on the Services by a user in a way that constitutes trademark infringement, please provide our Designated Copyright Agent (specified above) with the following information:</p>
                    <ol>
                        <li>
                            <p>Your full legal name and your electronic or physical signature.</p>
                        </li>
                        <li>
                            <p>Information reasonably sufficient to permit us to contact you or your authorized agent, including a name, mailing address, telephone number and, if available, an email address.</p>
                        </li>
                        <li>
                            <p>Identification of the Mark(s) alleged to have been infringed, including (i) for registered Marks, a copy of each relevant federal trademark registration certificate or (ii) for common law or other Marks, evidence sufficient to establish your claimed rights in the Mark, including the nature of your use of the Mark, and the time period and geographic area in which the Mark has been used by you.</p>
                        </li>
                        <li>
                            <p>Information reasonably sufficient to permit us to identify the use being challenged.</p>
                        </li>
                        <li>
                            <p>Include both of the following statements in the body of the Notice:</p>
                            <p>“I hereby state that I have not authorized the challenged use, and I have a good- faith belief that the challenged use is not authorized by law.”</p>
                            <p>“I hereby state under penalty of perjury that all of the information in the notification is accurate and that I am the owner of the Mark, or authorized to act on behalf of the owner of the Mark.”</p>
                        </li>
                    </ol>
            ...
            <li>
                <div>
                    <p><a href="//www.iubenda.com/privacy-policy/7764846" class="iubenda-white iubenda-embed" title="Privacy Policy">Privacy Policy</a></p>
