// adjust indention for readability; new classes; removed unecessary inline style
// FIXME: Need to cleanup comments
...
var displayInfo = function (src) {
    ...
    // title.style = "font-size:1.5em"; removed let css/less do his job 
    ...
    // line.style = "clear:both; border-bottom:1px solid #666; margin-bottom:13px"; replaced with ".divider"
    ...
    if (src.staff && src.staff.edges && src.staff.edges.length > 0) {
        ...
        // document.querySelector("#info").appendChild(br2); again css/less
        var h3 = document.createElement("h3");
        h3.innerText = "Staff";
        document.querySelector("#info").appendChild(h3);
        var div2 = document.createElement("div");
        // div2.style = "clear:both; border-bottom:1px solid #666; margin-bottom:3px"; replaced with ".divider"
        div2.setAttribute("class", "divider");
        document.querySelector("#info").appendChild(div2);

        var table2 = document.createElement("table");
        // table2.id = "staff"; removed; doesn't need anymore
    ...
    if (src.trailer && src.trailer && src.trailer.site === "youtube") {
        ...
        // document.querySelector("#info").appendChild(br3); again css/less
        var h32 = document.createElement("h3");
        h32.innerText = "Youtube PV";
        document.querySelector("#info").appendChild(h32);
        var div3 = document.createElement("div");
        // div3.style = "clear:both; border-bottom:1px solid #666; margin-bottom:3px"; replaced with ".divider"
        div3.setAttribute("class", "divider");
        document.querySelector("#info").appendChild(div3);
        var div4 = document.createElement("div");
        div4.innerHTML = "<iframe id=\"youtube\" height=\"360\" src=\"https://www.youtube.com/embed/" + src.trailer.id + "\" frameborder=\"0\" allowfullscreen></iframe>";
        document.querySelector("#info").appendChild(div4);
    }
    // var br4 = document.createElement("br");
    // br4.style = "clear:both";
    // document.querySelector("#info").appendChild(br4); again css/less
    var h33 = document.createElement("h3");
    h33.innerText = "Synopsis"; /* changed synopses to synopsis*/
    ...
    // div6.style = "text-align:justify"; removed text alignment
    div6.setAttribute("class", "description"); // add class instead
    ...
    if (src.characters && src.characters.edges && src.characters.edges.length > 0) {
        ...
        // document.querySelector("#info").appendChild(br5); again css/less
        var h34 = document.createElement("h3");
        h34.innerText = "Characters";
        document.querySelector("#info").appendChild(h34);
        var div7 = document.createElement("div");
        // div7.style = "clear:both; border-bottom:1px solid #666; margin-bottom:3px"; replaced with divider
        div7.setAttribute("class", "divider");
        document.querySelector("#info").appendChild(div7);

        var characterDIV = document.createElement("div");
        charactersDIV.setAttribute("class", "characters"); // add characters holder class
    ...
    // div9.style = "clear:both; border-bottom:1px solid #666; margin-bottom:3px"; replaced with divider
    div9.setAttribute("class", "divider");
    document.querySelector("#info").appendChild(div9);
    var div10 = document.createElement("div");
    div10.setAttribute("class", "provided"); // add class for footer
    ...
    // document.querySelector("#info").appendChild(div11); again css/less
};