...
<div class="container">
<div class="row">
    <div class="col-md-10 col-centered alert alert-info" style="box-shadow: 0 0 20px 0px;    ">
        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
		  <a href="https://www.patreon.com/posts/moving-to-new-22212117">See why whatanime.ga moved to trace.moe</a>
    </div>
</div>
...
<div class="row">
	...
	<div class="col-md-3" id="results-container">
		<div id="results-list">
...
<div class="row">
	<div id="info" class="col-md-8 pull-left">Some info of the project</div>
</div>
</div><!-- /.container-->
<!-- Github link -->
